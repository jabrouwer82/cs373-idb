...
gClooney = Celebrity(name='George Clooney',
                     description='&nbsp;&nbsp;&nbsp;&nbsp;George Timothy Clooney (born May 6, 1961) is an American actor, writer, producer, director, and activist. He has received three Golden Globe Awards for his work as an actor and two Academy Awards, one for acting and the other for producing.<br />&nbsp;&nbsp;&nbsp;&nbsp;Clooney made his acting debut on television in 1978, and later gained wide recognition in his role as Dr. Doug Ross on the long-running medical drama ER from 1994 to 1999, for which he received two Emmy Award nominations. While working on ER, he began attracting a variety of leading roles in films, including the superhero film Batman & Robin (1997) and the crime comedy Out of Sight (1998), in which he first worked with a director who would become a long-time collaborator, Steven Soderbergh. In 1999, Clooney took the lead role in Three Kings, a well-received war satire set during the Gulf War.<br />&nbsp;&nbsp;&nbsp;&nbsp;In 2001, Clooney\'s fame widened with the release of his biggest commercial success, the heist comedy Ocean\'s Eleven, the first of the film trilogy, a remake of the 1960 film with Frank Sinatra as Danny Ocean. He made his directorial debut a year later with the biographical thriller Confessions of a Dangerous Mind, and has since directed the drama Good Night, and Good Luck (2005), the sports comedy Leatherheads (2008), the political drama The Ides of March (2011), and the comedy-drama war film The Monuments Men (2014).<br />&nbsp;&nbsp;&nbsp;&nbsp;He won an Academy Award for Best Supporting Actor for the Middle East thriller Syriana (2005), and subsequently earned Best Actor nominations for the legal thriller Michael Clayton (2007), the comedy-drama Up in the Air (2009) and the drama The Descendants (2011). In 2013, he received the Academy Award for Best Picture for producing the political thriller Argo, alongside Ben Affleck and Grant Heslov. He is the only person ever to be nominated for Academy Awards in six categories.<br />&nbsp;&nbsp;&nbsp;&nbsp;Clooney is sometimes described as one of the most handsome men in the world. In 2005, TV Guide ranked Clooney No. 1 on its "50 Sexiest Stars of All Time" list. In 2009, he was included in Time\'s annual Time 100 as one of the "Most Influential People in the World". Clooney is also noted for his political activism and has served as one of the United Nations Messengers of Peace since January 31, 2008. His humanitarian work includes his advocacy of finding a resolution for the Darfur conflict, raising funds for the 2010 Haiti earthquake, 2004 Tsunami, and 9/11 victims, and creating documentaries such as Sand and Sorrow to raise awareness about international crises. He is also a member of the Council on Foreign Relations.',
...
rWitherspoon = Celebrity(name='Reese Witherspoon',
                         description='&nbsp;&nbsp;&nbsp;&nbsp;Laura Jeanne Reese Witherspoon (born March 22, 1976) is an American actress and producer. She made her film debut as the female lead in the film The Man in the Moon in 1991. In 1996, she appeared in Freeway and starred in Pleasantville in 1998. In 2000, she earned a Golden Globe Award for Best Actress – Comedy or Musical nomination for Election.<br />&nbsp;&nbsp;&nbsp;&nbsp;Witherspoon\'s breakthrough role came in 2001 with the box-office hit Legally Blonde and in 2002 she starred in the romantic comedy Sweet Home Alabama, which emerged as her biggest live-action commercial success. In 2005, Witherspoon received worldwide attention and praise for her portrayal of June Carter Cash in Walk the Line, which earned her the Academy Award, Golden Globe Award, BAFTA Award, Screen Actors Guild Award and the Critics Choice Award for Best Actress. Her other films include Legally Blonde 2: Red, White & Blonde (2003), Monsters vs. Aliens (2009) and Water for Elephants (2011). In 2014, Witherspoon produced the thriller Gone Girl and garnered praise for portraying Cheryl Strayed in Wild, for which she earned her second Best Actress nomination at the Academy Awards.<br />&nbsp;&nbsp;&nbsp;&nbsp;She married actor Ryan Phillippe in 1999; the couple separated in 2006 and divorced in 2007. She married talent agent Jim Toth in 2011. Witherspoon owns a production company, Pacific Standard and she is actively involved in children\'s and women\'s advocacy organizations. She serves on the board of the Children\'s Defense Fund (CDF) and was named Global Ambassador of Avon Products in 2007, serving as honorary chair of the charitable Avon Foundation. In December 2010, Witherspoon received a star on the Hollywood Walk of Fame.',
...
wRyder = Celebrity(name='Winona Ryder',
                   description='&nbsp;&nbsp;&nbsp;&nbsp;Winona Ryder (born Winona Laura Horowitz; October 29, 1971) is an American actress. She made her film debut in the 1986 film Lucas. As Lydia Deetz, a goth teenager in Tim Burton\'s Beetlejuice (1988), she won critical and popular recognition. After various appearances in film and on television, Ryder continued her acting career with the cult film Heathers (1988), a controversial satire of teenage suicide and high school life that drew Ryder further critical attention and commercial success. She later appeared in Mermaids (1990), earning a Golden Globe nomination, in Burton\'s Edward Scissorhands (1990), and in Francis Ford Coppola\'s gothic romance Bram Stoker\'s Dracula (1992).<br />&nbsp;&nbsp;&nbsp;&nbsp;Having played diverse roles in many well-received films, Ryder won a Golden Globe Award for Best Supporting Actress and an Academy Award nomination in the same category for her role in The Age of Innocence in 1993 as well as another Academy Award nomination, as Best Actress, for Little Women the following year. She later appeared in the Generation X cult hit Reality Bites (1994), Alien: Resurrection (1997), the Woody Allen comedy Celebrity (1998), and Girl, Interrupted (1999), which she also executive-produced. In 2000, Ryder received a star on the Walk of Fame in Hollywood, California.<br />&nbsp;&nbsp;&nbsp;&nbsp;Ryder\'s personal life has attracted significant media attention. Her relationship with Johnny Depp and a 2001 arrest for shoplifting were constant subjects of tabloid journalism. She has since revealed her personal struggles with anxiety and depression. In 2002, she appeared in the box office smash Mr. Deeds. In 2006, Ryder returned to the screen after a brief hiatus, later appearing in high-profile films such as Star Trek. In 2010, she was nominated for two Screen Actors Guild Awards: as the lead actress in When Love Is Not Enough: The Lois Wilson Story and as part of the cast of Black Swan. She also reunited with Burton for Frankenweenie (2012).',
...
#Crimes
possessionMarijuana = Crime('Possession of Marijuana', 'http://en.wikipedia.org/wiki/Drug_possession', description="Marijuana possession is a drug possession offense with severity varying from state to state. Drug possession is the crime of having one or more illegal drugs in one's possession, either for personal use, distribution, sale or otherwise. Illegal drugs fall into different categories and sentences vary depending on the amount, type of drug, circumstances, and jurisdiction. A person has possession of drugs if he or she has actual physical control of the drugs (they have the drugs in their hands) or if the drugs are on that person. A person also has possession of drugs if he or she has the power and intent to control their disposition and use.")
possessionHeroine = Crime('Possession of Heroine', 'http://en.wikipedia.org/wiki/Drug_possession', description="Heroine possession is a drug possession offense. Drug possession is the crime of having one or more illegal drugs in one's possession, either for personal use, distribution, sale or otherwise. Illegal drugs fall into different categories and sentences vary depending on the amount, type of drug, circumstances, and jurisdiction. A person has possession of drugs if he or she has actual physical control of the drugs (they have the drugs in their hands) or if the drugs are on that person. A person also has possession of drugs if he or she has the power and intent to control their disposition and use.")
possessionCocaine = Crime('Possession of Cocaine', 'http://en.wikipedia.org/wiki/Drug_possession', description="Cocaine possession is a drug possession offense. Drug possession is the crime of having one or more illegal drugs in one's possession, either for personal use, distribution, sale or otherwise. Illegal drugs fall into different categories and sentences vary depending on the amount, type of drug, circumstances, and jurisdiction. A person has possession of drugs if he or she has actual physical control of the drugs (they have the drugs in their hands) or if the drugs are on that person. A person also has possession of drugs if he or she has the power and intent to control their disposition and use.")
possessionParaphernalia = Crime('Possession of Drug Paraphernalia', 'http://en.wikipedia.org/wiki/Drug_paraphernalia', description="\"Drug paraphernalia\" is a term used, often with a slightly negative connotation due to its use in criminal law (e.g. \"possession of drug paraphernalia\"), to denote any equipment, product, or material that is modified for making, using, or concealing drugs, typically for recreational purposes. According to the Federal Drug Paraphernalia Statute, 21 USC 863, which is part of the Controlled Substances Act, in the USA it is illegal to sell, transport through the mail, transport across state lines, import, or export drug paraphernalia as defined. Possession is usually illegal under State law. The law gives specific guidance on determining what constitutes drug paraphernalia.")
resistingArrest = Crime('Resisting Arrest', 'http://en.wikipedia.org/wiki/Resisting_arrest', description="In some countries, resisting arrest is a criminal charge against an individual who has committed, depending on the jurisdiction, at least one of the following acts: fleeing a police officer while being arrested; threatening a police officer with physical violence while being arrested; physically struggling to free oneself from being restrained (handcuffed or put into the police vehicle); attacking a police officer while being arrested; or providing an officer with false identification (either verbally or by presentation of a false official document, i.e. a fake ID).")
possessionFirearm = Crime('Possession of Concealed Firearm', 'http://en.wikipedia.org/wiki/Weapon_possession', description="Criminal possession of a weapon is the unlawful possession of a weapon by a citizen. Possession of a concealed firearm falls under the umbrella of criminal possession of a weapon (where the weapon is a hidden firearm). Many societies both past and present have placed restrictions on what forms of weaponry private citizens (and to a lesser extent police) are allowed to purchase, own, and carry in public. Such crimes are public order crimes and are considered mala prohibita, in that the possession of a weapon in and of itself is not evil. Rather, the potential for use in acts of unlawful violence creates a possible need to control them. Some restrictions are strict liability, whereas others require some element of intent to use the weapon for an illegal purpose. Some regulations allow a citizen to obtain a permit or other authorization to possess the weapon under certain circumstances. Lawful uses of weapons by civilians commonly include hunting, sport, collection and self-preservation.")
underInfContSubstance = Crime('Under the Influence of a Controlled Substance', 'http://en.wikipedia.org/wiki/Altered_state_of_consciousness', description="Willfully using a controlled substance or narcotic drug and being under the influence of this substanace in any detectable manner at the time of arrest.")
...
charges = [
  ...
  Charge(dMX, possessionCocaine, date(2004, 6, 26), None, description='DMX was arrested in June 2004, at the John F. Kennedy International Airport, on charges of cocaine possession, criminal impersonation, criminal possession of a weapon, criminal mischief, menacing, and driving under the influence of drugs or alcohol, while claiming to be a federal agent and attempting to carjack a vehicle. He was given a conditional discharge on December 8, 2004, but pled guilty on October 25, 2005, to violating parole.'),
  
  Charge(dMX, impersonation, date(2004, 6, 26), None, description='DMX was arrested in June 2004, at the John F. Kennedy International Airport, on charges of cocaine possession, criminal impersonation, criminal possession of a weapon, criminal mischief, menacing, and driving under the influence of drugs or alcohol, while claiming to be a federal agent and attempting to carjack a vehicle. He was given a conditional discharge on December 8, 2004, but pled guilty on October 25, 2005, to violating parole.'),
  
  Charge(dMX, possessionGunFelon, date(2004, 6, 26), None, description='DMX was arrested in June 2004, at the John F. Kennedy International Airport, on charges of cocaine possession, criminal impersonation, criminal possession of a weapon, criminal mischief, menacing, and driving under the influence of drugs or alcohol, while claiming to be a federal agent and attempting to carjack a vehicle. He was given a conditional discharge on December 8, 2004, but pled guilty on October 25, 2005, to violating parole.'),
  
  Charge(dMX, mischief, date(2004, 6, 26), None, description='DMX was arrested in June 2004, at the John F. Kennedy International Airport, on charges of cocaine possession, criminal impersonation, criminal possession of a weapon, criminal mischief, menacing, and driving under the influence of drugs or alcohol, while claiming to be a federal agent and attempting to carjack a vehicle. He was given a conditional discharge on December 8, 2004, but pled guilty on October 25, 2005, to violating parole.'),
  
  Charge(dMX, menacing, date(2004, 6, 26), None, description='DMX was arrested in June 2004, at the John F. Kennedy International Airport, on charges of cocaine possession, criminal impersonation, criminal possession of a weapon, criminal mischief, menacing, and driving under the influence of drugs or alcohol, while claiming to be a federal agent and attempting to carjack a vehicle. He was given a conditional discharge on December 8, 2004, but pled guilty on October 25, 2005, to violating parole.'),
  
  Charge(dMX, dUI, date(2004, 6, 26), 'John F. Kennedy International Airport', description='DMX was arrested in June 2004, at the John F. Kennedy International Airport, on charges of cocaine possession, criminal impersonation, criminal possession of a weapon, criminal mischief, menacing, and driving under the influence of drugs or alcohol, while claiming to be a federal agent and attempting to carjack a vehicle. He was given a conditional discharge on December 8, 2004, but pled guilty on October 25, 2005, to violating parole.'),
  
  Charge(dMX, violatingParole, date(2005, 11, 18), None, description='DMX was sentenced to 70 days in jail on November 18, 2005, for violating parole; the lateness charge added a 10-day extension to the original 60-day sentence. DMX was released early (for "good behavior") on December 30, 2005.'),

  Charge(dMX, possessionMarijuana, date(2008, 12, 30), None, description='DMX pled guilty to charges of drug possession, theft, and animal cruelty, at a hearing on December 30, 2008; he was sentenced to ninety days in jail on January 31, 2009.'),

  Charge(dMX, theft, date(2008, 12, 30), None, description='DMX pled guilty to charges of drug possession, theft, and animal cruelty, at a hearing on December 30, 2008; he was sentenced to ninety days in jail on January 31, 2009.'),
  
  Charge(dMX, animalCruelty, date(2008, 12, 30), None, description='DMX pled guilty to charges of drug possession, theft, and animal cruelty, at a hearing on December 30, 2008; he was sentenced to ninety days in jail on January 31, 2009.'),

  Charge(dMX, aggrAssault, date(2009, 5, 22), None, description='On May 22, 2009, DMX entered a plea agreement/change of plea, and pled guilty to attempted aggravated assault'),
  ...
  Charge(dMX, recklessDriving, date(2011, 8, 24), None, description='DMX was arrested on August 24, 2011, for speeding (recorded as 102 mph in a 65 mph zone), reckless driving, and driving with a suspended license. While DMX admitted to speeding, he claims he was driving 85 mph, not 102 mph as charged.'),

  Charge(dMX, drivingSansLicense, date(2011, 8, 24), None, description='DMX was arrested on August 24, 2011, for speeding (recorded as 102 mph in a 65 mph zone), reckless driving, and driving with a suspended license. While DMX admitted to speeding, he claims he was driving 85 mph, not 102 mph as charged.'),

  Charge(dMX, drivingSansLicense, date(2013, 2, 13), 'Spartanburg, South California', description='DMX was arrested on February 13, 2013 in Spartanburg, South Carolina for driving without a drivers license.'),

  Charge(dMX, dUI, date(2013, 7, 26), 'Greenville County, South Calofirnia', description='He was arrested again on July 26, 2013 in Greenville County, South Carolina and charged with driving under the influence of alcohol, as well as driving without a license.'),
  
  Charge(dMX, drivingSansLicense, date(2013, 7, 26), 'Greenville County, South Calofirnia', description='He was arrested again on July 26, 2013 in Greenville County, South Carolina and charged with driving under the influence of alcohol, as well as driving without a license.'),

  Charge(dMX, trafficViolation, date(2013, 8, 20), 'Greer, South California', description='DMX was arrested on August 20, 2013 in Greer, South Carolina during a traffic stop after a car he was a passenger in made an improper u-turn. He was arrested due to an outstanding warrant for driving under suspension. Four packages of marijuana were also found in the vehicle, and he along with the driver were cited for them.'),
  ...
  Charge(mSheen, tresspassing, date(2000, 8, 12), 'Vandenberg Air Force Base, California', description='Martin was one of 22 people arrested for crossing over a line established by the Air Force in an anti-militarization protest at California\'s Vandenberg Air Force base. He was charged with trespassing.'),
